...
#define LV_USE_FS_LITTLEFS 0
    ...
    #define LV_FS_LITTLEFS_LETTER 'S'//'\0'  /**< Set an upper-case driver-identifier letter for this driver (e.g. 'A'). */
...
#define LV_USE_FS_ARDUINO_ESP_LITTLEFS 0
    ...
    #define LV_FS_ARDUINO_ESP_LITTLEFS_LETTER 'S'//'\0'  /**< Set an upper-case driver-identifier letter for this driver (e.g. 'A'). */
